...
public class CoraTSVReaderTest {

	@Test
	public void testReadCoraTSV() throws Exception {

		ClassLoader classLoader = getClass().getClassLoader();
		URL resource = classLoader.getResource("cora_ren.tsv");

		AnnotatedTextFileReader reader = new CoraTSVReader("#", "§");
